...
public class ProductsController {
    ...
    public ProductDTO update(@PathVariable long id, @RequestBody ProductUpdateDTO productData) {
        ...
        toEntityUp(productData, product);
        productRepository.save(product);
        var productDto = toDTO(product);
    ...
    private Product toEntityUp(ProductUpdateDTO upProd, Product prod){
        prod.setTitle(upProd.getTitle());
        prod.setPrice(upProd.getPrice());
        return prod;
    }
